...
some of the commands:
    "pong": opens pong.
    "v1k": opens one key mania.
    "fnf": opens 4 key mania. this is a misnomer.
    "reopen": reopens the base game.
    "quit" or "exit": quits the game.
    "reopen " + ...: reopens the game but with an input of whatever was after "reopen ". some things that do something are:
        "mania"
        "v1k"
        "fnf" this is also a misnomer. i haven't built actual fnf, not yet at least.
